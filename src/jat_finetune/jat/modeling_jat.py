...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_shape: Tuple[int, int, int], out_channels: int) -> None:
        ...
        self.shortcut = nn.Sequential(
            nn.Conv2d(in_shape[0], out_channels, kernel_size=1, stride=1),
...
class JatModel(GPTNeoPreTrainedModel):
    ...
    def forward(
        ...
        # RL tasks
        elif continuous_observations is not None or discrete_observations is not None or image_observations is not None:
